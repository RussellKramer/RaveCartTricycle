...
{    
    ...
    0x1267,                 // Vendor ID
    //#if SIDE == RIGHT
    //	0x0001,                 // Product ID: 1 = RIGHT PANEL
   // #elif SIDE == LEFT
    	0x0002,                 // Product ID: 2 = LEFT PANEL
   // #elif SIDE == FRONT
  // 		0x0003,                 // Product ID: 3 = FRONT PANEL  
  //  #endif
...
'P','I','C',' ','E','N','C','O','D','E','R',' ','V','1','.','0','0',' ','J','W','B'};

rom const unsigned char *rom USB_CD_Ptr[]={ ( const unsigned char *)&cfg01,( const unsigned char *)&cfg01};
rom const unsigned char *rom USB_SD_Ptr[]={( const unsigned char *)&sd000,( const unsigned char *)&sd001,( const unsigned char *)&sd002};
